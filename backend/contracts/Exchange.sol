...
contract Exchange is ERC20 {
    ...
    //Exchange is inheriting ERC20, because exchange would keep track of Crypto Dex LP tokens
    ...
    function addLiquidity(uint256 _amount) public payable returns (uint256) {
        ...
        if (cryptoDevTokenReserve == 0) {
            ...
            require(
                ...
                "Amount of tokens sent is less tan the minimum tokens requires"
            );
    ...
    */
    function ethToCryptoDevToken(uint256 _minTokens) public payable {
        ...
        require(tokensBought >= _minTokens, "insufficient output amout");
